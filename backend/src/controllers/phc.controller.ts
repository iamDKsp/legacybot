    ...
    try {
        ...
        const doc = await db('phc_documents as pd')
            ...
            .select(
                ...
                'l.employment_status as lead_employment_status',
                'l.occupation_detail as lead_occupation_detail',
...
export const downloadPhcPdf = async (req: Request, res: Response): Promise<void> => {
    ...
    try {
        ...
        const lead = {
            ...
            employment_status:   doc.lead_employment_status  as string | null,
            occupation_detail:   doc.lead_occupation_detail  as string | null,
