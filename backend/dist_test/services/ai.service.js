...
exports.aiService = exports.DEFAULT_STAGE_PROMPT = exports.FUNNEL_STAGE_PROMPTS = exports.BOT_SYSTEM_PROMPT = void 0;
exports.buildCompressedHistory = buildCompressedHistory;
exports.getRelevantMemories = getRelevantMemories;
exports.buildLeadContext = buildLeadContext;
exports.recordSuccessPattern = recordSuccessPattern;
...
exports.sendTypingPresence = sendTypingPresence;
exports.sendFragmentedMessage = sendFragmentedMessage;
exports.downloadBridgeMedia = downloadBridgeMedia;
const generative_ai_1 = require("@google/generative-ai");
const env_1 = require("../config/env");
const axios_1 = __importDefault(require("axios"));
const database_1 = require("../config/database");
const genAI = new generative_ai_1.GoogleGenerativeAI(env_1.config.googleAi.apiKey);
// Startup diagnostic
console.log(`[AI] Models loaded: chat=${env_1.config.googleAi.model}, media=${env_1.config.googleAi.mediaModel}, apiKey=${env_1.config.googleAi.apiKey ? '✅ SET (' + env_1.config.googleAi.apiKey.substring(0, 8) + '...)' : '❌ MISSING'}`); // ============================================================
...
// ============================================================
exports.BOT_SYSTEM_PROMPT = `Você se chama "Sofia", assistente de atendimento da Legacy Assessoria Jurídica.
...
// ============================================================
exports.FUNNEL_STAGE_PROMPTS = {
    // ── Geral (Triagem Inicial) ─────────────────────────────
    geral: {
        reception: `[Instrução de Etapa — RECEPÇÃO GERAL]
O cliente acabou de entrar em contato. Seu objetivo aqui é fazer uma triagem. Pergunte de forma gentil o que aconteceu para que possamos ajudá-lo. NÃO peça documentos, CPF ou nome agora. Apenas procure entender o problema para identificar qual a área jurídica adequada (Trabalhista, Consumidor, Fraude, etc).`,
    ...
    // ── Cliente Negativado ──────────────────────────────────
    negativado: {
        reception: `[Instrução de Etapa — RECEPÇÃO - NEGATIVADO]
O cliente acabou de entrar em contato. Cumprimente de forma calorosa e pergunte o que trouxe ele até a Legacy hoje. Seja natural. JAMAIS peça nome, CPF ou documentos agora.`,
        approach: `[Instrução de Etapa — ABORDAGEM - NEGATIVADO]
...
ATENÇÃO: NÃO peça nome, CPF ou endereço — essas informações serão extraídas automaticamente dos documentos.`,
        doc_request: `[Instrução de Etapa — DOCUMENTAÇÃO - NEGATIVADO]
...
NÃO peça nome, CPF ou endereço — essas informações são extraídas dos documentos. Peça UM DOCUMENTO POR VEZ.`,
        analysis: `[Instrução de Etapa — ANÁLISE - NEGATIVADO]
...
NÃO continue fazendo perguntas. NÃO dê prazo específico.`,
    ...
    // ── Golpe do Pix ───────────────────────────────────────
    'golpe-pix': {
        reception: `[Instrução de Etapa — RECEPÇÃO - GOLPE PIX]
O cliente acabou de entrar em contato. Cumprimente com calor e pergunte o que trouxe ele à Legacy. Não peça nenhum dado ainda.`,
        approach: `[Instrução de Etapa — ABORDAGEM - GOLPE PIX]
...
ATENÇÃO: NÃO peça nome, CPF ou endereço — essas informações serão extraídas dos documentos.`,
        info_collection: `[Instrução de Etapa — COLETA DE INFORMAÇÕES - GOLPE PIX]
...
4. Colete o depoimento completo: como aconteceu o golpe, quem entrou em contato, o que foi prometido.`,
        doc_request: `[Instrução de Etapa — DOCUMENTAÇÃO - GOLPE PIX]
...
NÃO peça nome, CPF ou endereço. Peça UM DOCUMENTO POR VEZ.`,
        procuracao_docs: `[Instrução de Etapa — PROCURAÇÃO - GOLPE PIX]
...
Neste momento, informe ao cliente que os documentos foram recebidos e que estamos processando as informações. Diga que em breve um assessor entrará em contato para as próximas etapas (envio da procuração para assinatura).`,
        analysis: `[Instrução de Etapa — ANÁLISE - GOLPE PIX]
...
NÃO continue fazendo perguntas. Seu trabalho neste atendimento está concluído.`,
    ...
    // ── Trabalhista ────────────────────────────────────────
    trabalhista: {
        reception: `[Instrução de Etapa — RECEPÇÃO - TRABALHISTA]
O cliente acabou de entrar em contato. Cumprimente com calor e pergunte o que trouxe ele à Legacy. Não peça nenhum dado ainda.`,
        approach: `[Instrução de Etapa — ABORDAGEM - TRABALHISTA]
...
4. NÃO peça documentos ainda. ATENÇÃO: NÃO peça nome, CPF ou endereço — essas informações serão extraídas dos documentos.`,
        doc_request: `[Instrução de Etapa — DOCUMENTAÇÃO - TRABALHISTA]
...
NÃO peça nome, CPF ou endereço. Peça UM DOCUMENTO POR VEZ.`,
        analysis: `[Instrução de Etapa — ANÁLISE - TRABALHISTA]
...
NÃO continue fazendo perguntas.`,
    ...
    // ── Golpe Cibernético ──────────────────────────────────
    'golpe-cibernetico': {
        reception: `[Instrução de Etapa — RECEPÇÃO - GOLPE CIBERNÉTICO]
...
Cumprimente com calor e transmita tranquilidade imediata. Pergunte o que aconteceu de forma empática. Não peça dados ainda.`,
        approach: `[Instrução de Etapa — ABORDAGEM - GOLPE CIBERNÉTICO]
...
4. NÃO peça documentos ainda. ATENÇÃO: NÃO peça nome, CPF ou endereço — essas informações serão extraídas dos documentos.`,
        doc_request: `[Instrução de Etapa — DOCUMENTAÇÃO - GOLPE CIBERNÉTICO]
...
NÃO peça nome, CPF ou endereço. Peça UM DOCUMENTO POR VEZ.`,
        analysis: `[Instrução de Etapa — ANÁLISE - GOLPE CIBERNÉTICO]
...
exports.DEFAULT_STAGE_PROMPT = {
    reception: `[Instrução de Etapa — RECEPÇÃO]
O cliente acabou de entrar em contato. Cumprimente de forma calorosa e natural e pergunte o que trouxe ele à Legacy hoje. JAMAIS peça nome, CPF ou documentos agora.`,
    analysis: `[Instrução de Etapa — ANÁLISE]
...
// ============================================================
function buildCompressedHistory(messages, maxMessages = 4) {
...
async function getRelevantMemories(userMessage) {
    try {
        ...
        if (keywords.length === 0)
            return '';
        const patterns = await (0, database_1.db)('bot_memory')
        ...
        const lines = relevant
            .slice(0, 3)
            .map((p) => {
            if (p.category === 'case_type_signal')
                return `- Área provável: ${p.legal_area}`;
            if (p.successful_response)
                return `- Resposta comprovada: "${p.successful_response.slice(0, 150)}"`;
            return null;
        })
            .filter(Boolean);
...
async function buildLeadContext(leadId) {
    try {
        const lead = await (0, database_1.db)('leads')
            .leftJoin('funnels', 'leads.funnel_id', 'funnels.id')
            .where('leads.id', leadId)
            .select('leads.name', 'leads.cpf', 'leads.bot_stage', 'leads.gender', 'leads.status', 'funnels.slug as funnel_slug')
            .first();
        if (!lead)
            return '';
        ...
        const funnelPrompts = exports.FUNNEL_STAGE_PROMPTS[funnelSlug];
        const stageInstruction = funnelPrompts?.[botStage] ??
            exports.DEFAULT_STAGE_PROMPT[botStage] ??
        ...
        try {
            const knowledgeFiles = await (0, database_1.db)('knowledge_files')
...
// ============================================================
async function recordSuccessPattern(userMessage, botReply, legalArea = null, converted = false) {
    try {
        const trigger = userMessage.slice(0, 200).toLowerCase();
        // Check if similar pattern exists
        const existing = await (0, database_1.db)('bot_memory')
            .where('category', 'success_pattern')
            .whereRaw('LOWER(trigger_pattern) LIKE ?', [`%${trigger.slice(0, 50)}%`])
            .first();
        if (existing) {
            await (0, database_1.db)('bot_memory')
                .where('id', existing.id)
                .increment('usage_count', 1)
                .update({
                lead_converted: converted ? true : Boolean(existing.lead_converted),
                confidence_score: Math.min(100, existing.confidence_score + (converted ? 5 : 1)),
            });
        }
        else {
            await (0, database_1.db)('bot_memory').insert({
...
// ============================================================
async function generateBotReply(conversationHistory, userMessage, leadContext = '', memories = '') {
    if (!env_1.config.googleAi.apiKey) {
    ...
    try {
        ...
        const model = genAI.getGenerativeModel({
            model: env_1.config.googleAi.model,
        ...
        const timeoutPromise = new Promise((_, reject) => setTimeout(() => reject(new Error('Gemini API timeout after 30s')), 30000));
...
async function analyzeImage(imageBase64, mimeType, context = '') {
    ...
    console.log(`[AI] 🖼️ Analyzing image | mime: ${mimeType} | size: ${base64SizeKB}KB | model: ${env_1.config.googleAi.mediaModel}`);
    // Use dedicated media model (supports vision/image analysis)
    const model = genAI.getGenerativeModel({ model: env_1.config.googleAi.mediaModel });
    const imagePart = {
        inlineData: {
            data: imageBase64,
            mimeType: mimeType,
...
- "Desconhecido" apenas se não conseguir identificar de forma alguma`;
    ...
    for (let attempt = 1; attempt <= MAX_ATTEMPTS; attempt++) {
        try {
            ...
            const timeoutPromise = new Promise((_, reject) => setTimeout(() => reject(new Error(`Image analysis timeout after ${timeoutMs / 1000}s`)), timeoutMs));
            const result = await Promise.race([
            ...
            if (jsonMatch) {
                ...
                const analysisResult = {
                    ...
                    docType: parsed.docType ?? 'Desconhecido',
...
async function transcribeAudio(audioBase64, mimeType) {
    ...
    const audioModel = env_1.config.googleAi.mediaModel;
    ...
    try {
        ...
        const timeoutPromise = new Promise((_, reject) => setTimeout(() => reject(new Error('Audio transcription timeout after 30s')), 30000));
        const result = await Promise.race([
        ...
        console.error('[AI] 🎤 Audio transcription error:', err?.message || err);
        return '';
    }
}
// ============================================================
...
// ============================================================
async function generateHandoffSummary(leadName, legalArea, recentMessages) {
    if (!env_1.config.googleAi.apiKey)
        return 'Novo lead recebido. Verificar histórico.';
    try {
        const model = genAI.getGenerativeModel({ model: env_1.config.googleAi.model });
...
// ============================================================
async function generateCaseSummary(leadName, cpf, funnelSlug, allMessages) {
    if (!env_1.config.googleAi.apiKey)
        return `Caso de ${leadName} — verificar histórico de conversa.`;
    try {
        const model = genAI.getGenerativeModel({ model: env_1.config.googleAi.model });
        const areaLabels = {
...
Mensagens do cliente: ${msgSummary}`;
        const timeoutPromise = new Promise((_, reject) => setTimeout(() => reject(new Error('Case summary timeout after 20s')), 20000));
        const result = await Promise.race([
        ...
        console.error('[AI] generateCaseSummary error:', err?.message);
...
async function sendWhatsAppMessage(phone, message) {
    if (!env_1.config.whatsapp.apiUrl || !env_1.config.whatsapp.apiKey) {
        console.warn('[WhatsApp] API not configured — skipping send');
        return;
    }
    const url = `${env_1.config.whatsapp.apiUrl}/message/sendText/${env_1.config.whatsapp.instance}`;
    try {
        await axios_1.default.post(url, {
            ...
            headers: {
                apikey: env_1.config.whatsapp.apiKey,
...
// ============================================================
async function sendWhatsAppImage(phone, imageBase64, mimeType = 'image/png', caption = '') {
    if (!env_1.config.whatsapp.apiUrl || !env_1.config.whatsapp.apiKey) {
        console.warn('[WhatsApp] API not configured — skipping image send');
        return;
    }
    const url = `${env_1.config.whatsapp.apiUrl}/message/sendImage/${env_1.config.whatsapp.instance}`;
    try {
        await axios_1.default.post(url, {
            number: phone.includes('@') ? phone : phone.replace(/\D/g, ''),
            imageBase64,
...
// ============================================================
async function sendTypingPresence(phone, durationMs = 2000) {
    if (!env_1.config.whatsapp.apiUrl || !env_1.config.whatsapp.apiKey)
        return;
    try {
        await axios_1.default.post(`${env_1.config.whatsapp.apiUrl}/chat/sendPresence/${env_1.config.whatsapp.instance}`, {
            number: phone.includes('@') ? phone : phone.replace(/\D/g, ''),
            options: { presence: 'composing', delay: durationMs },
        }, {
            headers: { apikey: env_1.config.whatsapp.apiKey, 'Content-Type': 'application/json' },
            timeout: 5000,
        });
    }
    catch {
...
// ============================================================
async function sendFragmentedMessage(phone, message, abortSignal) {
...
async function downloadBridgeMedia(msg) {
    try {
        ...
        console.error('[AI] downloadBridgeMedia error:', err?.message || err);
        return null;
    }
}
// ============================================================
